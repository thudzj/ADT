...
class CategoricalConditionalBatchNorm(torch.nn.Module):
    ...
    def __init__(self, num_features, num_cats=10, eps=2e-5, momentum=0.1, affine=True,
...
def define_G(input_nc, output_nc, ngf, netG, zero_pad=False, norm='batch', no_down_G=False, use_dropout=False, use_relu_atlast=False, init_type='normal', init_gain=0.02, gpu_ids=[torch.device('cuda:0')], outs=1):
    """Create a generator
    ...
    if netG == 'resnet_9blocks':
        net = ResnetGenerator(input_nc, output_nc, ngf, zero_pad=zero_pad, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, no_down_G=no_down_G, use_relu_atlast=use_relu_atlast, outs=outs)
    elif netG == 'resnet_6blocks':
        net = ResnetGenerator(input_nc, output_nc, ngf, zero_pad=zero_pad, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=6, no_down_G=no_down_G, use_relu_atlast=use_relu_atlast, outs=outs)
    elif netG == 'resnet_3blocks':
        net = ResnetGenerator(input_nc, output_nc, ngf, zero_pad=zero_pad, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=3, no_down_G=no_down_G, use_relu_atlast=use_relu_atlast, outs=outs)
    elif netG == 'unet_128':
...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, zero_pad=False, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', no_down_G=False, use_relu_atlast=False, outs=1):
        ...
        model += [ResnetBlock(256, padding_type='zero' if zero_pad else padding_type, norm_layer=norm_layer, use_dropout=use_dropout, use_bias=use_bias, use_relu_atlast=use_relu_atlast, dim2=512)]
        model += [ResnetBlock(512, padding_type='zero' if zero_pad else padding_type, norm_layer=norm_layer, use_dropout=use_dropout, use_bias=use_bias, use_relu_atlast=use_relu_atlast, dim2=512)]
        model += [ResnetBlock(512, padding_type='zero' if zero_pad else padding_type, norm_layer=norm_layer, use_dropout=use_dropout, use_bias=use_bias, use_relu_atlast=use_relu_atlast, dim2=256)]
